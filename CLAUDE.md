...
- `week4-world-cafe.html` — Week 4 World Café deck (Activity 12): projection deck introducing the World Café method and running it over the four decline claims, with a print-only sheet of four A6 index-card blanks. Built to `SLIDES.md`
